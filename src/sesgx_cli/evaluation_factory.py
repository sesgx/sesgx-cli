...
from .citation_graph import directed_adjacency_list_to_undirected, snowballing
...
def similarity_score(
    ...
    first_set_matrix = tfidf_matrix[0 : len(small_set)]  # type: ignore
    second_set_matrix = tfidf_matrix[len(small_set) : len(small_set) + len(other_set)]  # type: ignore
